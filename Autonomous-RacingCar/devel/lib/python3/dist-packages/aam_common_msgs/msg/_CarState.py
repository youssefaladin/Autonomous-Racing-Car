...
"""autogenerated by genpy from aam_common_msgs/CarState.msg. Do not edit."""
import codecs
import sys
...
class CarState(genpy.Message):
  ...
  _type = "aam_common_msgs/CarState"
...
geometry_msgs/Pose2D car_state_dt   # Velocity in x, y, theta"""
  ...
  _slot_types = ['std_msgs/Header','geometry_msgs/Pose2D','aam_common_msgs/CarStateDt']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.car_state_dt is None:
        self.car_state_dt = aam_common_msgs.msg.CarStateDt()
    else:
      self.header = std_msgs.msg.Header()
      self.car_state = geometry_msgs.msg.Pose2D()
      self.car_state_dt = aam_common_msgs.msg.CarStateDt()
