...
"""autogenerated by genpy from aam_common_msgs/Map.msg. Do not edit."""
import codecs
import sys
...
import aam_common_msgs.msg
import geometry_msgs.msg
import std_msgs.msg

class Map(genpy.Message):
  _md5sum = "d926454e54ff8605a5b5a6710745bd29"
  _type = "aam_common_msgs/Map"
...
string data
"""
  __slots__ = ['header','cone_yellow','cone_blue','orange','cone_unknow']
  _slot_types = ['std_msgs/Header','aam_common_msgs/Cone[]','aam_common_msgs/Cone[]','aam_common_msgs/Cone[]','aam_common_msgs/Cone[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,cone_yellow,cone_blue,orange,cone_unknow
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.cone_blue:
        ...
        _x = val1
        buff.write(_get_struct_4d().pack(_x.ratioX, _x.ratioY, _x.pcX, _x.pcY))
      length = len(self.orange)
      buff.write(_struct_I.pack(length))
      for val1 in self.orange:
        _v5 = val1.position
        _x = _v5
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        _v6 = val1.color
