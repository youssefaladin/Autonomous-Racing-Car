...
(cl:defmethod cl:initialize-instance :after ((m <Mission>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Mission)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name aam_common_msgs-msg:<Mission> is deprecated: use aam_common_msgs-msg:Mission instead.")))
...
(cl:defmethod mission-val ((m <Mission>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader aam_common_msgs-msg:mission-val is deprecated.  Use aam_common_msgs-msg:mission instead.")
  (mission m))

(cl:ensure-generic-function 'finished-val :lambda-list '(m))
(cl:defmethod finished-val ((m <Mission>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader aam_common_msgs-msg:finished-val is deprecated.  Use aam_common_msgs-msg:finished instead.")
  (finished m))
