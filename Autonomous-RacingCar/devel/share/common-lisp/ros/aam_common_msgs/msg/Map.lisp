...
(cl:defmethod cl:initialize-instance :after ((m <Map>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Map)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name aam_common_msgs-msg:<Map> is deprecated: use aam_common_msgs-msg:Map instead.")))
...
(cl:defmethod cone_yellow-val ((m <Map>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader aam_common_msgs-msg:cone_yellow-val is deprecated.  Use aam_common_msgs-msg:cone_yellow instead.")
  (cone_yellow m))

(cl:ensure-generic-function 'cone_blue-val :lambda-list '(m))
(cl:defmethod cone_blue-val ((m <Map>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader aam_common_msgs-msg:cone_blue-val is deprecated.  Use aam_common_msgs-msg:cone_blue instead.")
  (cone_blue m))

(cl:ensure-generic-function 'orange-val :lambda-list '(m))
(cl:defmethod orange-val ((m <Map>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader aam_common_msgs-msg:orange-val is deprecated.  Use aam_common_msgs-msg:orange instead.")
  (orange m))

(cl:ensure-generic-function 'cone_unknow-val :lambda-list '(m))
(cl:defmethod cone_unknow-val ((m <Map>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader aam_common_msgs-msg:cone_unknow-val is deprecated.  Use aam_common_msgs-msg:cone_unknow instead.")
  (cone_unknow m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <Map>) ostream)
  ...
  (cl:let ((__ros_arr_len (cl:length (cl:slot-value msg 'orange))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) __ros_arr_len) ostream))
  (cl:map cl:nil #'(cl:lambda (ele) (roslisp-msg-protocol:serialize ele ostream))
   (cl:slot-value msg 'orange))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Map>) istream)
  ...
  (cl:let ((__ros_arr_len 0))
    ...
    (cl:setf (cl:ldb (cl:byte 8 16) __ros_arr_len) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 24) __ros_arr_len) (cl:read-byte istream))
  (cl:setf (cl:slot-value msg 'orange) (cl:make-array __ros_arr_len))
  (cl:let ((vals (cl:slot-value msg 'orange)))
    (cl:dotimes (i __ros_arr_len)
    (cl:setf (cl:aref vals i) (cl:make-instance 'aam_common_msgs-msg:Cone))
  (roslisp-msg-protocol:deserialize (cl:aref vals i) istream))))
  (cl:let ((__ros_arr_len 0))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Map>)))
  ...
  "d926454e54ff8605a5b5a6710745bd29")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Map)))
  "Returns md5sum for a message object of type 'Map"
  "d926454e54ff8605a5b5a6710745bd29")
...
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <Map>))
  (cl:+ 0
     ...
     4 (cl:reduce #'cl:+ (cl:slot-value msg 'orange) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ (roslisp-msg-protocol:serialization-length ele))))
