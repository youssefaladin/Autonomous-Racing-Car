...
(cl:defmethod cl:initialize-instance :after ((m <CarStateDt>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CarStateDt)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name aam_common_msgs-msg:<CarStateDt> is deprecated: use aam_common_msgs-msg:CarStateDt instead.")))
