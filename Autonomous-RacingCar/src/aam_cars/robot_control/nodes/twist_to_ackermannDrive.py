...
# Note that twistToAckermannDrive needs to be mapped to the robot_control/command parameter in the command line ie. rosrun aamfsd_robot_control twist_to_ackermannDrive.py twistToAckermannDrive:=aamfsd_robot_control/command
