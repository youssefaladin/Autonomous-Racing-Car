...
class ukalmanFilter():
    def __init__(self):
        ...
        self.Cx = np.diag([0.25*0.05,0.25*0.05, np.deg2rad(5)*0.05])
    ...
    def predict(self):
                if self.keys[0] == 1 and self.keys[1] == 1:
                    ...
                    #print("nu2")
                    #print(nu2)
                    self.predictedcov=predicted_cov+nu2
                    ...
                    self.update(newcones,oldcones,cones)
    ...
    def update (self,newcones,oldcones,cones):
          ...
          self.predictedmean=self.statevector
          self.predictedcov=self.covmat
