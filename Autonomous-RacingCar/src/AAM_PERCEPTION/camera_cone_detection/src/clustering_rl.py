...
def euclidean_clustering_callback(msg):
    ...
    ec.set_ClusterTolerance(1)  # Adjust this value as needed

    # Set the minimum and maximum cluster size
    ec.set_MinClusterSize(20)  # Adjust these values as needed
    ...
    for i in range(len(cluster_indices)):
        ...
        cones.append([totalx/u,totaly/u,totalz/u,totalr/u,totalg/u,totalb/u])
    print(len(cones))    
    print(cones)
    print("....................")    
